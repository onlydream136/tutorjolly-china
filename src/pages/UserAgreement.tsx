      ...
      <main className="flex-1 pt-20">
        <div className="container mx-auto px-4 py-12 max-w-4xl">
          <article className="prose prose-lg dark:prose-invert max-w-none">
            <h1 className="text-3xl font-bold text-foreground mb-8">Tutor Jolly用户协议</h1>
            ...
            <h2 className="text-2xl font-semibold text-foreground mt-8 mb-4">1. 协议的范围与确认</h2>
            ...
            <h2 className="text-2xl font-semibold text-foreground mt-8 mb-4">2. 账户注册与管理</h2>
            <p className="text-muted-foreground leading-relaxed">
            ...
            <h2 className="text-2xl font-semibold text-foreground mt-8 mb-4">3. 服务内容与购买</h2>
            <p className="text-muted-foreground leading-relaxed">
            ...
            <p className="text-muted-foreground leading-relaxed">3.3 取消订阅与退款：</p>
            <p className="text-muted-foreground leading-relaxed">
            ...
            <h2 className="text-2xl font-semibold text-foreground mt-8 mb-4">4. 用户行为规范</h2>
            <p className="text-muted-foreground leading-relaxed">
            ...
            <h2 className="text-2xl font-semibold text-foreground mt-8 mb-4">5. 知识产权</h2>
            <p className="text-muted-foreground leading-relaxed">
            ...
            <h2 className="text-2xl font-semibold text-foreground mt-8 mb-4">6. 免责声明</h2>
            <p className="text-muted-foreground leading-relaxed">
            ...
            <h2 className="text-2xl font-semibold text-foreground mt-8 mb-4">7. 服务的变更、中断、终止</h2>
            <p className="text-muted-foreground leading-relaxed">
            ...
            <h2 className="text-2xl font-semibold text-foreground mt-8 mb-4">8. 法律适用、管辖与其他</h2>
            <p className="text-muted-foreground leading-relaxed">
            ...
            <h2 className="text-2xl font-semibold text-foreground mt-8 mb-4">9. 联系我们</h2>
            <p className="text-muted-foreground leading-relaxed">
